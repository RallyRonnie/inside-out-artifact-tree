describe("When using the tree roll up utilities with a root array", function() {
    it("should roll up value from child to parent",function(){
        ...
        var root_items = Rally.technicalservices.util.TreeBuilding.rollup({
            ...
            field_name: 'PlanEstimate'
        });
        expect(root_items.length).toEqual(1);
        expect(root_items[0].get('PlanEstimate')).toEqual(5);
    });
    
    it("should not fail when trying to roll up value from child to parent for non-existent field",function(){
        var parent_story = Ext.create('mockStory',{
            ObjectID: 1,
            Name: 'test parent'
        });
        ...
        expect(root_items.length).toEqual(1);
        expect(root_items[0].get('Fred')).toEqual(0);
    });
    
    it("should roll up value from children to parent",function(){
        var parent_story = Ext.create('mockStory',{
            ObjectID: 1,
            Name: 'test parent'
        });
        ...
        expect(root_items.length).toEqual(1);
        expect(root_items[0].get('PlanEstimate')).toEqual(12);
    });
    
    it("should roll up value from multiple levels of children to parent",function(){
        var parent_story = Ext.create('mockStory',{
            ObjectID: 1,
            Name: 'test parent'
        });
    ...
    it("should roll up value from multiple levels of children to parent when including midlevels",function(){
        var parent_story = Ext.create('mockStory',{
            ObjectID: 1,
            Name: 'test parent',
            PlanEstimate: 5
        ...
        expect(root_items.length).toEqual(1);
        expect(root_items[0].get('PlanEstimate')).toEqual(20);
    });
    ...
    it("should roll up value from multiple levels of children to parent when ignoring midlevels",function(){
        ...
        expect(root_items.length).toEqual(1);
        expect(root_items[0].get('PlanEstimate')).toEqual(10);
    });
    
    it("should roll up value from multiple levels of asymmetric children to parent when ignoring midlevels",function(){
        var parent_story = Ext.create('mockStory',{
            ObjectID: 1,
            Name: 'test parent',
            PlanEstimate: 1
        ...
        expect(root_items.length).toEqual(1);
        expect(root_items[0].get('PlanEstimate')).toEqual(43);
    });
    
    it("should roll up value from child to parent when different types",function(){
